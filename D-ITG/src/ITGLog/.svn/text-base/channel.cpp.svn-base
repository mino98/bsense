...
void logPacketTCP(int newSockSignal, ofstream *out)
{
	...
	PRINTD(1,"Number of received packets : %d \n",numRecvdPkt);
	PRINTD(1,"Number of received infos : %d \n",numTrip);
}
